<?php
session_start();
require_once 'staff_layout.php'; // ✅ تضمين الهيكل الموحد
require_once 'db.php';
...
// ✅ تأكد أن staff_id محفوظ في الجلسة، وإلا نقوم بجلبه وتخزينه
if (!isset($_SESSION['staff_id'])) {
    $user_id = $_SESSION['user_id'];

    // جلب staff_id من جدول الموظفين
    ...
    if ($row) {
        ...
        die("❌ لم يتم العثور على بيانات الموظف المرتبطة بهذا الحساب.");
    }
}
...
<h2 class="mb-4 text-center text-danger">لوحة تحكم الموظف</h2>
